...
//	    m_draggedPartnerSqi = m_positionMotionListener.getPartnerSqi(m_position, m_draggedFrom);
    ...
    private final static String[] whiteStoneStrings = { "k", "p", "q", "r", "b", "n", " ", "m", "v", "t", "w", "o",
	    "l" }, blackStoneStrings = { "K", "P", "Q", "R", "B", "N", "+", "M", "V", "T", "W", "O", "L" };

    private String getStringForStone(int stone, boolean isWhiteSquare) {
	String s = isWhiteSquare ? whiteStoneStrings[stone - Chess.MIN_STONE]
