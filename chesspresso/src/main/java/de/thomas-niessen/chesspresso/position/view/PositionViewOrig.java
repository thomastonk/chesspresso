...
public class PositionViewOrig extends java.awt.Component implements PositionListener, MouseListener, MouseMotionListener {
	 ...
	 */
	public PositionViewOrig(AbstractMutablePosition position) {
	 ...
	 */
	public PositionViewOrig(AbstractMutablePosition position, int bottomPlayer) {
		m_position = position;
	...
	private final static String[] whiteStoneStrings = { "k", "p", "q", "r", "b", "n", " ", "m", "v", "t", "w", "o", "l" },
			blackStoneStrings = { "K", "P", "Q", "R", "B", "N", "+", "M", "V", "T", "W", "O", "L" };

	private String getStringForStone(int stone, boolean isWhiteSquare) {
		String s = isWhiteSquare ? whiteStoneStrings[stone - Chess.MIN_STONE] : blackStoneStrings[stone - Chess.MIN_STONE];
		return s;
	}
